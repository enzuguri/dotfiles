...
- **Ports** (per `skills/boundaries.md`) are best specified as capability intersections — not a monolithic `UserPort` but the minimum capabilities each consumer needs.
